...
public class Dijkstra {
	 ...
	 */
	public void oneToAll(int start, GraphReader reader, Scanner scn) {
		...
		do {
			try {
				int node = Integer.parseInt(readLine("Cost to what node?",scn));
		...
		} while (readLine("New request? (y/n)",scn).equals("y"));
	 ...
	 */
	public String readLine(String message, Scanner scan){
